...
class ShadowHandSwitch(BaseTask):
    ...
    def reset(self, env_ids, goal_env_ids):
        ...
        self.prev_targets[env_ids, self.num_shadow_hand_dofs*2 + 1:self.num_shadow_hand_dofs*2 + 1*2] = to_torch([0], device=self.device)
        self.cur_targets[env_ids, self.num_shadow_hand_dofs*2 + 1:self.num_shadow_hand_dofs*2 + 1*2] = to_torch([0], device=self.device)
