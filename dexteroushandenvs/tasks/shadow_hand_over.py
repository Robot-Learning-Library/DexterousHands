...
class ShadowHandOver(BaseTask):
    ...
    def compute_observations(self):
        ...
        elif self.obs_type == "point_cloud_for_distill":
            self.compute_point_cloud_observation(collect_demonstration=True)
    ...
    def compute_point_cloud_observation(self, collect_demonstration=False):
        ...
        if collect_demonstration:
            ...
            self.student_obs_buf[:, obj_obs_start:obj_obs_start+13] = torch.zeros_like(self.student_obs_buf[:, obj_obs_start:obj_obs_start+13])
