...
COLORS=(
    [
"darkblue", "blueviolet", "blue", "violet", "dodgerblue", 'gold', "orange", "chocolate", "red"
    ]
)
...
if __name__ == "__main__":
    ...
    input_output_path = args.output_path
    ...
    for task_name in ["humanoid"]:
        ...
        args.root_dir = input_root_dir
        args.output_path = input_output_path + "/" + task_name + ".png"
