        ...
        for tfevent_file in t:
            ...
            if alg_type == "sarl":
                for i, test_rew in enumerate(ea.scalars.Items("Train/mean_reward")):
                    content.append(
                        [
                            test_rew.step,   # if env is to lift a pot, change it as test_rew.step * 20 * 2048
...
if __name__ == "__main__":
    ...
    task_envs = ["8env", "16env", "32env", "64env", "128env", "256env", "512env", "1024env", "2048env"]
    alg_name = args.alg_name
    for i, task_name in enumerate(task_envs):
        args.alg_name = alg_name + "_%s" %task_name
